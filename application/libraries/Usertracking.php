...
class Usertracking {
	...
	public function track_this() {
		...
		$input_data['user_identifier'] = array_key_exists('user_id', (array) $temp) ? $temp['user_id'] : $temp;
		$input_data['admin_identifier'] = array_key_exists('admin_id', (array) $temp) ? $temp['admin_id'] : NULL;
