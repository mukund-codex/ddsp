(function ($) {
    ...
    $('.approveAction').on('click', function (e) {
        console.log("In Approve Actions");
        e.preventDefault();
        $this = $(this).closest('form');
        ...
        swal({
            ...
            if (result.value) {
                ...
                var data = $this.serialize();
                var status = $('.approveAction').attr('data-status');
                
                var url = $this.attr('action')+status;
    ...
    /*Disapprove selected records*/
    $('.disapproveAction').on('click', function (e) {
        console.log("In Approve Actions");
        e.preventDefault();
        $this = $(this).closest('form');
        ...
        swal({
            ...
            showCancelButton: true,
            confirmButtonColor: '#d33',
            confirmButtonText: 'Yes, Disapprove Selected!',
            cancelButtonText: 'No, cancel!',
            showLoaderOnConfirm: true
        }).then(function (result) {
            if (result.value) {
                ...
                var status = $('.disapproveAction').attr('data-status');
